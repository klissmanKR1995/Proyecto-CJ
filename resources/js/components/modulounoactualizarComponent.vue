          ...
          <h5 class="text-center"> Actualizar Información <i> (Modulo - I) </i> </h5> <br>
            ...
            <div class="container"> 
              ...
              <div class="form-row">
                ...
                <div class="col-md-4">
                  <label for="inputState1">¿Habla lengua indigena?</label>
                   <select id="inputState1" class="form-control" v-model="modulouno.habla_lengua_indigena">
                    <option selected>Seleccionar</option>
                    <option>Si</option>
                    <option>No</option>
                  </select>
              ...
              <div class="form-row">
                <div class="col-md-4">
                 <label for="inputState1">¿Habla lengua extranjera?</label>
                  <select id="inputState1" class="form-control" v-model="modulouno.habla_lengua_extranjera">
                    <option selected>Seleccionar</option>
                    <option>Si</option>
                    <option>No</option>
                  </select>
