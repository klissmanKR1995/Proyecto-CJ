    ...
    <div class="modal-content"> <br>
          ...
          <h5 class="text-center"> Actualizar Información <i> (Modulo - I) </i> </h5> <br>
            ...
            <div class="container"> 
              ...
              <div class="container">
                ...
                <div class="form-row">
                  <div class="col-md-4">
                    <label for="inputState1">Datos de las partes</label>
                  ...
                  <div class="col-md-4">
                    <label for="inputState1">Razon Social</label>
              ...
              <div class="form-row">
                  <div class="col-md-4">
                    <label for="inputState1">Pais de nacimiento</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
                      paises' :model.sync="result1" v-model="modulouno.pais"></vue-select>
                  </div>
                  <div class="col-md-4">
                    <label for="inputState1">Estado de nacimiento</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
                      estados' :model.sync="result1" v-model="modulouno.estados"></vue-select>
                  </div>
                  <div class="col-md-4">
                    <label for="inputState1">Municipio de nacimiento</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
              ...
              <div class="form-row">
                  <div class="col-md-4">
                    <label for="inputState1">Nacionalidad</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
                      nacionalidades' :model.sync="result1" v-model="modulouno.nacionalidad"></vue-select>
                  </div>
                  <div class="col-md-4">
                    <label for="inputState1">Pais habitual</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
                      paises' :model.sync="result1" v-model="modulouno.pais_habitual"></vue-select>
                  </div>
                  <div class="col-md-4">
                    <label for="inputState1">Estado habitual</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
                      estados' :model.sync="result1" v-model="modulouno.estado_habitual"></vue-select>
                  </div>
              </div> 

              <div class="form-row">
                  <div class="col-md-4">
                    <label for="inputState1">Municipio habitual</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
                      municipios' :model.sync="result1" v-model="modulouno.municipio_habitual"></vue-select>
                  </div>
                  <div class="col-md-4">
                   <label for="inputState1">Tipo domicilio</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
                      tipoDomicilio' :model.sync="result1" v-model="modulouno.tipo_domicilio"></vue-select>
                  </div>
                  <div class="col-md-4">
                    <label for="inputState1">Tipo discapacidad</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
              ...
              <div class="form-row">
                ...
                <div class="col-md-4">
                <label for="inputState1">Tipo lengua indigena</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
              ...
              <div class="form-row">
                ...
                <div class="col-md-4">
                  <label for="inputState1">Ocupación</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
                      ocupacion' :model.sync="result1" v-model="modulouno.trabaja_ocupacion"></vue-select>
                </div>
                <div class="col-md-4">
                <label for="inputState1">Condicion actividad</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
              ...
              <div class="form-row">
                <div class="col-md-4">
                 <label for="inputState1">Sexo representación</label>
                    <vue-select class="vue-select1" name="id_valor" label="valor_variable" :options='
      ...
      <form @submit.prevent="agregar" v-else>
          ...
          <div class="container"> 
            ...
            <div class="form-row">
              <div class="col-md-4">
               <label for="inputState4">¿Habla español?</label>
                <select id="inputState4" class="form-control" v-model="modulouno.habla_español">
                  <option selected>Seleccionar</option>
                  <option>Si</option>
                  <option>No</option>
                </select>
              ...
              <div class="col-md-4">
                <label for="inputState5">¿Habla lengua indigena?</label>
                 <select id="inputState5" class="form-control" v-model="modulouno.habla_lengua_indigena">
                  <option selected>Seleccionar</option>
                  <option>Si</option>
                  <option>No</option>
                </select>
            ...
            <div class="form-row">
              <div class="col-md-4">
               <label for="inputState6">¿Habla lengua extranjera?</label>
                <select id="inputState6" class="form-control" v-model="modulouno.habla_lengua_extranjera">
                  <option selected>Seleccionar</option>
                  <option>Si</option>
                  <option>No</option>
                </select>
