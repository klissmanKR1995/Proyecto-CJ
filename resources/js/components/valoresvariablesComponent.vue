  ...
  <div>
    <div class="modal-content"> <br>
       <form @submit.prevent="editar(valorescatalogo)" v-if="editarActivo">
          ...
          <input type="text" class="form-control mb-2" placeholder="Escribe un valor para el catalogo" v-model="valorescatalogo.valor_variable"></input><br>
       ...
       methods:{
            ...
            agregar(){
                ...
                axios.post('/Proyecto-CJ/public/valorescatalogos', params)     
                    .then(res => {
                        this.valorescatalogos.push(res.data)
                        console.log(res)
                    })     
            },
